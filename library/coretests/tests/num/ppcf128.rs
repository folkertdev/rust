...
fn normalize() {
    ...
    cfg_select! {
        target_endian = "little" => {
            ...
            // The small component of an infinity is normalized to zero.
            assert_eq_normalized!((f64::INFINITY, 42.0) ==> (f64::INFINITY, 0.0));
            assert_eq_normalized!((f64::NEG_INFINITY, 42.0) ==> (f64::NEG_INFINITY, 0.0));
        }
        target_endian = "big" => {
            // Covers powerpc64 (elfv1), powerpc and aix.
            // The small component of an infinity is untouched.
            assert_eq_normalized!((f64::INFINITY, 42.0) ==> (f64::INFINITY, 42.0));
            assert_eq_normalized!((f64::NEG_INFINITY, 42.0) ==> (f64::NEG_INFINITY, 42.0));
        }
    }
