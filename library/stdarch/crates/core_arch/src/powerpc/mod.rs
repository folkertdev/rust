...
impl ppcf128 {
    ...
    #[unstable(feature = "powerpc_ppcf128", issue = "161787")]
    pub const MIN: Self = Self([f64::MIN, f64::MIN * f64::EPSILON / 4.0]);

    /// Largest finite `ppcf128` value.
    #[unstable(feature = "powerpc_ppcf128", issue = "161787")]
    pub const MAX: Self = Self([f64::MAX, f64::MAX * f64::EPSILON / 4.0]);
...
impl PartialOrd for ppcf128 {
    ...
    fn partial_cmp(&self, other: &ppcf128) -> Option<crate::cmp::Ordering> {
        self.to_components().partial_cmp(&other.to_components())
    }
}
