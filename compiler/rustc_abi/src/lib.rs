...
pub enum Float {
    ...
    F32,
    F64,
    /// `x87_f80`, the x87 80-bit extended-precision format. Like `f16b` this is not a builtin type
    /// in Rust (it is exposed as a lang item), but it is a builtin type in LLVM.
    ///
